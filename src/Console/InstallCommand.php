...
class InstallCommand extends Command
{
    ...
    protected function configure()
    {
        $this
            ->setName('install')
            ->setDescription('Install Winter CMS.')
            ->addOption(
                'force',
                null,
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if (array_key_exists('project', $this->config->cms)) {
            ...
            $this->artisan->call('winter:util set project --projectId=' . $this->config->cms['project']);
        }
        ...
        if ($pluginsDeclarations) {
            $this->write('Installing plugins of winter-cms.yaml...');
        ...
        if ($this->firstRun) {
            ...
            $this->artisan->call('winter:fresh');
